...
2. 월세 
  ...
  • 보증금은 계약 종료 후 전액 돌려받는 것이 원칙입니다.
       ...
       ※ 월세 또는 공과금이 밀리는 등특수상황이 발생할 경우, 그 금액만큼 보증금에서 제하고 돌려받을 수 있습니다.
...
1. 국민연금 (National Pension) 
  ...
  • 가입 대상: 만 18세 ~ 59세의 모든 근로자 및 사업자. 외국인도 한국에서 고용되어 있으면 국민연금에 가입해야 합니다.
...
2. 건강보험 (National Health Insurance) 
  ...
  • 가입 대상: 모든 외국인 근로자는 입국 후 6개월 이상 체류 시 가입 의무화, 고용 형태에 따라 회사에서 자동 가입되거나 개인이 직접 가입해야 합니다.
...
3. 고용보험 (Employment Insurance) 
  ...
  • 가입 대상: 정규직, 계약직 등 대부분의 근로자. 단, 단시간 근로자(주 15시간 미만)나 일부 특수 직종은 가입이 제외됩니다.
...
4. 산재보험 (Workers’ Compensation Insurance) 
  ...
  • 가입 대상: 모든 근로자 (외국인 포함), 고용 형태나 근무 시간과 관계없이 자동 가입해야 합니다. 
  ...
  • 혜택: 업무 중 부상, 질병 치료비 지원. 장애 발생 시 보상금 지급, 사망 시 유족 보상금 지급합니다. 
      ...
      ※ 외국인 근로자에 대한 특이 사항 
            ...
            - 본국과의 사회보장 협정: 한국과 외국인 근로자 본국 간 사회보장 협정이 있는 경우, 국민연금 또는 건강보험의 가입과 반환금 수령이 조정될 수 있습니다. 
...
★ 노동법에 관한 더 많은 정보는 고용노동부(http://www.moel.go.kr  [한, 영])에서 얻을 수 있습니다.
